...
#   RUNE_EDITOR_MODE  string  "modal" | "helix" | "standard" | "emacs" — the
#                             resolved host editor mode (empty when not yet
#                             known). "modeless" is a deprecated alias for
#                             "standard". The host substitutes exo with its
#                             configured editor.exo.fallback value before
#                             invoking this script, so "exo" never reaches
#                             here.
#
